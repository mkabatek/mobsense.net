...
var db = new MongoDB(dbName, new Server(dbHost, dbPort, {auto_reconnect: true}), {w: 1});
	...
	if (e) {
		...
		console.log('[account-manager.js]' + 'connected to database :: ' + dbName);
	}
});
...
accounts.find().toArray(function(e,o){
    ...
    if (e != null || e != null){
        ...
        if(o.length < numAccounts){
            ...
            console.log('Not accepting new accounts, check back later')
            callback('Not accepting new accounts, check back later', null);
